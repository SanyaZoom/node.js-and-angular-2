...
export = {
    ...
    bsclient: {
        create: sql('bsclient/create.sql')
    },
    bssaldocard: {
        create: sql('bssaldocard/create.sql')
    },
    bsservice: {
        create: sql('bsservice/create.sql')
    },
    bsservint: {
        create: sql('bsservint/create.sql')
    },
    bsservrollback: {
        create: sql('bsservrollback/create.sql')
    }
};
